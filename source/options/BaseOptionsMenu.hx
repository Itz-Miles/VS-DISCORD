...
class BaseOptionsMenu extends MusicBeatSubstate
{
	...
	function changeSelection(change:Int = 0)
	{
		...
		descText.text = (descText.text == "relative") ? "If checked, the conductor judges notes up to "
			+ ClientPrefs.hitWindow
			+ "ms away from it." : optionsArray[curSelected].description;
